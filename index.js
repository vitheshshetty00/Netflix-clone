...
function fetchTrendingMovies(){
    fetchAndBuildMoviesSections(apiPaths.fetchTrending, 'Trending Now')
    .then(list => {
...
function buildBannerSection(movie){
    ...
    div.innerHTML = `
    <h2 class="banner-title">${movie.title
    }</h2>
    <P class="banner-info">Trending in Movies | Realeased : ${movie.release_date}</P>
...
function fetchAndBuildMoviesSections(fetchUrl, categoryName) {
